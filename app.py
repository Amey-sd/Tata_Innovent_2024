...
model1 = YOLO(r"E:/repos/Tata_Innovent_2024/models/Yolov8/Medium/weights/best.pt")
app = Flask(__name__)
UPLOAD_FOLDER = 'static/uploads'
PROCESSED_FOLDER = 'static/processed'

model2 = YOLO(r"E:/repos/Tata_Innovent_2024/models/Yolov8/Mini/weights/best.pt")
app = Flask(__name__)
UPLOAD_FOLDER = 'static/uploads'
PROCESSED_FOLDER = 'static/processed'
